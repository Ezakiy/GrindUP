...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" +System.Windows.Forms.Application.StartupPath +@"\Gym Data.mdf;Integrated Security=True;Connect Timeout=30");
        }
